...
//Executing the quantum circuit with given number of shots and printing the values in a table/list format
  ...
  for(int i=0;i<number_of_shots;i++)
    {
      ...
      else if(f<((qs2[0]*qs2[0])+((qs2[1]*qs2[1]))))
      {
executearray2[1]++;
      }
      else if(f<((qs2[0]*qs2[0])+(qs2[1]*qs2[1])+(qs2[2]*qs2[2])))
      {
executearray2[2]++;
      }
      else 
   ...
   for(int i=0;i<number_of_shots;i++)
    {
      ...
      else if(f<(qs3[0]*qs3[0])+(qs3[1]*qs3[1]))
      {
        //cout<<
        executearray3[1]++;
      }
      else if(f<(qs3[0]*qs3[0])+(qs3[1]*qs3[1])+(qs3[2]*qs3[2]))
      {
        //cout<<
        executearray3[2]++;
      }
      else if(f<(qs3[0]*qs3[0])+(qs3[1]*qs3[1])+(qs3[2]*qs3[2])+(qs3[3]*qs3[3]))
      {
        //cout<<
        executearray3[3]++;
      }
      else if(f<(qs3[0]*qs3[0])+(qs3[1]*qs3[1])+(qs3[2]*qs3[2])+(qs3[3]*qs3[3])+(qs3[4]*qs3[4]))
      {
        //cout<<
        executearray3[4]++;
      }
      else if(f<(qs3[0]*qs3[0])+(qs3[1]*qs3[1])+(qs3[2]*qs3[2])+(qs3[3]*qs3[3])+(qs3[4]*qs3[4])+(qs3[5]*qs3[5]))
      {
        //cout<<
        executearray3[5]++;
      }
      else if(f<(qs3[0]*qs3[0])+(qs3[1]*qs3[1])+(qs3[2]*qs3[2])+(qs3[3]*qs3[3])+(qs3[4]*qs3[4])+(qs3[5]*qs3[5])+(qs3[6]*qs3[6]))
      {
        executearray3[6]++;
      }
      else
...
//Read Unitary method to print the unitary matrix 
...
//Function to perform Tensor Product/Kronecker Product
...
/*
Defining Quantum Gates Methods
*/
...
{
if(number_of_qubits==1)             //one qubit systems
{
for(int i=0;i<4;i++)
{
for(int j=0;j<4;j++)
...
Matrix_Product(*matrix2,*unitary_1q,2,2,*unitary_1q_final,2);
for(int i=0;i<2;i++)
{
  for(int j=0;j<2;j++)
  {
...
else if(number_of_qubits==2)      //two qubit systems
{
if(qubitposition==1)
{
...
else if( number_of_qubits==3)       //three qubit systems
{
if(qubitposition==0)
{
